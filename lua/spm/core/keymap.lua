...
---@class spm.KeymapSpec: spm.Validatable
...
setmetatable(KeymapSpec, { __index = Validatable })

KeymapSpec.schema = {
  map = { type = 'string' },
  cmd = { type = { 'string', 'function' } },
  desc = { type = 'string', optional = true },
  ft = { type = 'string', optional = true },
}
