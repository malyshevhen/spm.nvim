...
describe('error', function()
  ...
  it('should create a result from a function that might throw', function()
    ...
    local result = Result.try(function() return expected end)

    assert.is_true(result:is_ok())
    assert.are.same(expected, result:unwrap())
  end)

  it('should create a result from a function that might throw with an error', function()
    local result = Result.try(function() error('Something went wrong') end)

    assert.is_true(result:is_err())
    assert.truthy(result:unwrap_err().message:find('Something went wrong'))
  end)
